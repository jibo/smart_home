...
import com.example.myapplication.utils.bluetooth.BluetoothHelper;
import com.example.myapplication.utils.bluetooth.interfaces.IBTBoudListener;
import com.example.myapplication.utils.bluetooth.interfaces.IBTConnectListener;
import com.example.myapplication.utils.bluetooth.interfaces.IBTScanListener;
import com.example.myapplication.utils.bluetooth.interfaces.IBTStateListener;
import com.example.myapplication.utils.bluetooth.interfaces.IBluetoothHelper;
import com.example.myapplication.utils.BtItemBean;
import com.example.myapplication.utils.SimpleAdapter;

import java.util.List;
import java.util.Set;

public class DevicesMangerActivity extends AppCompatActivity implements SimpleAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_devices_manger);
        ...
        public void onStateChange(int state) {
            switch (state){
                case BluetoothAdapter.STATE_OFF:
                    Toast.makeText(DevicesMangerActivity.this,"蓝牙已关闭",Toast.LENGTH_SHORT).show();
                    mSwBluetooth.setChecked(mBluetoothHelper.isEnable());
                ...
                case BluetoothAdapter.STATE_ON:
                    Toast.makeText(DevicesMangerActivity.this,"蓝牙已打开",Toast.LENGTH_SHORT).show();
                    mSwBluetooth.setChecked(mBluetoothHelper.isEnable());
...
//                startActivity(discoverableIntent);
    ...
    private IBTScanListener mBTScanListener=new IBTScanListener() {
        ...
        public void onScanStart() {//搜索开始
            Toast.makeText(DevicesMangerActivity.this,"搜索开始",Toast.LENGTH_SHORT).show();
        }
        ...
        public void onBondStateChange(BluetoothDevice dev) {
            if(dev.getBondState()==BluetoothDevice.BOND_BONDED) {//已配对
                ...
                if(btUseItem!=null&&btUseItem.getState()==BtItemBean.STATE_BONDING){
                    Toast.makeText(DevicesMangerActivity.this,"请确认配对设备已打开且在通信范围内",Toast.LENGTH_SHORT).show();
                }
